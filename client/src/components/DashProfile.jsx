...
export default function DashProfile() {
  ...
  const uploadImage = async () => {
    ...
    uploadTask.on(
      ...
      (error) => {
        setimageFileUploadError("Image upload fail.File must be less than 2Mb");
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        >
          ...
          <img
            ...
            alt="user"
            className={`rounded-full w-full h-full object-cover border-8 colour-[lightgray] ${
              imageFileUploadProgress &&
      ...
      >
        ...
        <Modal.Body>
          <div className="text-center">
            <HiOutlineExclamationCircle className="h-14 w-14 text-orange-400 mb-4 mx-auto" />
